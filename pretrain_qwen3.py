...
DEFAULT_CONFIG_FILENAME: str = "qwen3_pretrain_override.yaml"
...
def parse_cli_args() -> Tuple[argparse.Namespace, list[str]]:
    ...
    parser = argparse.ArgumentParser(
        description="Pretrain Qwen3 model using Megatron-Bridge with YAML and CLI overrides",
    ...
    parser.add_argument(
        ...
        help="Path to the YAML OmegaConf override file. Default: qwen3_pretrain_override.yaml",
    )
    parser.add_argument("--debug", action="store_true", help="Enable debug logging")
    parser.add_argument("--proxy", action="store_true", help="Use proxy model")
    parser.add_argument("--optimizer-type", type=str, default="adam", help="Optimizer type, [muon, adam]")
    parser.add_argument(
        "--data-paths", 
        type=str,
        nargs='+',
...
def main() -> None:
    """
    Entry point for the Qwen3 pretraining script.
    ...
    Examples of CLI usage:
        ...
        python pretrain_qwen3.py optimizer.lr=0.0003

        # Custom config file with additional overrides
        python pretrain_qwen3.py --config-file my_config.yaml train.train_iters=500000

        # Multiple overrides for distributed training
        python pretrain_qwen3.py \
    ...
    logger.info("Megatron-Bridge Qwen3 Pretraining Script with YAML & CLI Overrides")
    logger.info("------------------------------------------------------------------")

    #TODO: qwen3_pretrain_config needs to be updated to suuport muon optimizer
